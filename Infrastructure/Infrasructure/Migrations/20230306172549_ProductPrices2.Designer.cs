...
namespace Infrastructure.Infrasructure.Migrations
{
    ...
    [Migration("20230306172549_ProductPrices2")]
    partial class ProductPrices2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.PriceListAggregate.PriceItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Core.Entities.PriceListAggregate.ProductPriceItem", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("TEXT");

                    b.Property<string>("PriceItemId")
                        .HasColumnType("TEXT");

                    b.Property<string>("Id")
                        .HasColumnType("TEXT");

                    b.Property<long>("PriceDate")
                        .HasColumnType("INTEGER");

                    b.HasKey("ProductId", "PriceItemId");

                    b.HasIndex("PriceItemId");

                    b.ToTable("ProductPriceItems");
                });
            ...
            modelBuilder.Entity("Core.Entities.PriceListAggregate.ProductPriceItem", b =>
                {
                    b.HasOne("Core.Entities.PriceListAggregate.PriceItem", "PriceItem")
                        .WithMany("ProductsPriceItems")
            ...
            modelBuilder.Entity("Core.Entities.PriceListAggregate.PriceItem", b =>
                {
                    b.Navigation("ProductsPriceItems");
                });
