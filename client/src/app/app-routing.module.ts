...
const routes: Routes = [
  ...
  { path: 'test-error', component: TestErrorComponent, data: { breadcrumb: 'Not Found' } },
  ...
  { path: 'orders', canActivate: [AuthGuard], loadChildren: () => import('./order/orders.module').then(mod => mod.OrderModule), data: { breadcrumb: 'Orders' } },
